  ...
  const experiences = [
    {
      ...
      description: "Working on Katalon TestOps with microfrontend architecture and cloud-native microservices.",
      highlights: [
      ...
      technologies: ["ReactJS", "TanStack Query", "Material UI", "Quarkus", "Apache Kafka", "Java", "Kotlin"],
    },
    {
      ...
      location: "Ho Chi Minh City",
      description: "Led a team of 3 members to develop a full-stack platform for creating and sharing stories.",
      highlights: [
      ...
      technologies: ["Java Spring", "Spring Security", "Hibernate", "Flyway", "NextJS", "PostgreSQL"],
    },
    {
      ...
      location: "Ho Chi Minh City",
      description: "Worked on ThirdAI Supporter and ThirdAI Minutes Agent projects.",
      highlights: [
      ...
      technologies: ["FastAPI", "ReactJS", "NextJS", "Azure Cosmos DB", "PostgreSQL"],
    },
    {
      ...
      location: "Ho Chi Minh City",
      description: "Assisted teachers and explained algorithms and code to students.",
      highlights: [
    ...
    <section id="experience" className="py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="font-mono text-primary mb-8">{"> ls -la experience/"}</div>
